...
class OauthClients extends \Entities\OauthClients implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\OauthClients' . "\0" . 'clientSecret', '' . "\0" . 'Entities\\OauthClients' . "\0" . 'isPublic', '' . "\0" . 'Entities\\OauthClients' . "\0" . 'id', 'hashOptions'];
        }
    ...
    public function setIPublic($isPublic)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIPublic', [$isPublic]);

        return parent::setIPublic($isPublic);
    }
